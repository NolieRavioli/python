...
screen_width = 700
screen_height = 400
init_blocks = 10                #how many block should spawn at first
fps = 60                        #frames per second
falling_speed_divider = 3       #how slowly the blocks will fall
Fire_rate = 10                  #how many frames in between each shot
...
def canFire():
    ...
    if Fire_rate < cooldown:
        Fire_rate += 1
    elif Fire_rate == cooldown and mouseCheck()[0] == True:
        spawnBullet()
        Fire_rate = 0
...
while not running:
    randomColor()
    draw_text('Game Over', font, screen, (screen_width/2) - 64, 5, WHITE)
    draw_text('You killed: ', font, screen, (screen_width/2) - 64, 40, WHITE)
